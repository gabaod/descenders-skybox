...
public class DynamicSkyboxController : ModBehaviour
{
	...
	[Range(0f, 50f)]
	public float moonRotationSpeed = 0f;
	[Range(0f, 5f)]
	...
	[Header("Cloud Layers")]
	[Range(0f, 1f)]
	public float lowCloudCoverage = 0f;
	[Range(0f, 1f)]
